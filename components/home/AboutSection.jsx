...
export default function AboutSection() {
  return (
    <div className="bg-black py-14 text-white">
      <div className="max-w-[1440px] w-[90%] mx-auto flex gap-[140px] relative">
        <div className="relative">
          <p className="font-medium text-[64px]">AWARD WINNING PHOTOGRAPHER </p>
          <div className="flex flex-col gap-4 max-w-[320px] w-full absolute right-0">
            <p className="text-xl text-justify">
              ...
              quam pretium malesuada. Risus ullamcorper sed quis aliquam lacus
              rhoncus faucibus eu.
            </p>
            <Link
              href={"/about"}
